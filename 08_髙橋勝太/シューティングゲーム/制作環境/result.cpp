...
HRESULT InitResult(void)
{
	...
	//テキスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/BG3.jpg", &g_pTextureResult[0]);
	if (nCntEnemy > 0)
	{
		D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/gameover.png", &g_pTextureResult[1]);
	}
	else if (nCntEnemy <= 0)
	{
		D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/gemeclear.png", &g_pTextureResult[1]);
	}
